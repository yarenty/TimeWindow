...
final class MinusInfTimeWindow(val end:Date) extends InfiniteTimeWindow {
 ...
 override	def unary_- : TimeWindow = new PlusInfTimeWindow(end)
	...
	override def duration(): Long  = Long.MinValue
